...
# ============================================================
# BEP BREAK-EVEN POINT SCANNER PRO v4.9
# NEW in v4.9:
...
def main():
    st.set_page_config(page_title="BEP Scanner Pro v5.0", layout="wide")
    ...
    st.markdown('<div class="main-title">BEP BREAK-EVEN POINT SCANNER PRO v5.0</div>',
                unsafe_allow_html=True)
    st.markdown(
